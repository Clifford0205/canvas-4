  ...
  _createClass(Particle, [{
    ...
    value: function update(particles) {
      ...
      for (var i = 0; i < particles.length; i++) {
        ...
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__["distance"])(mouse.x, mouse.y, this.x, this.y) < 100) {
          console.log('周邊周邊');
          this.opacity += 0.002;
...
/*!*************************!*\
  !*** ./src/js/utils.js ***!
  \*************************/
/*! exports provided: randomIntFromRange, randomColor, distance, rotate, resolveCollision */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
